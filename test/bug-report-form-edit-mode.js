...
describe('bug-report-form-edit-mode', function () {
  ...
  describe('Summary', function () {
    ...
    it(`Page has the same titles as in Default State`, function () {
      ...
      const arrDefault = [];
      const arrEdit = [];
      arrDefault.push(browser.getText(locator.bugReportTitles.summary));
      arrDefault.push(browser.getText(locator.bugReportTitles.stepsToRep));
      arrDefault.push(browser.getText(locator.bugReportTitles.actRes));
      arrDefault.push(browser.getText(locator.bugReportTitles.expRes));
      arrDefault.push(browser.getText(locator.bugReportTitles.attach));
      arrDefault.push(browser.getText(locator.bugReportTitles.comments));

      arrEdit.push(browser.getText(locator.bugReportTitles.summary));
      arrEdit.push(browser.getText(locator.bugReportTitles.stepsToRep));
      arrEdit.push(browser.getText(locator.bugReportTitles.actRes));
      arrEdit.push(browser.getText(locator.bugReportTitles.expRes));
      arrEdit.push(browser.getText(locator.bugReportTitles.attach));
      arrEdit.push(browser.getText(locator.bugReportTitles.comments));
